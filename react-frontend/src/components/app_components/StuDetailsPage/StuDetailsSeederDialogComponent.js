...
import seederData from "./stuDetails.seeder.json";
...
const StuDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(StuDetailsSeederDialogComponent);
