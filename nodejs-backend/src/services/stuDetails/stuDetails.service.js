const { StuDetails } = require("./stuDetails.class");
const createModel = require("../../models/stuDetails.model");
const hooks = require("./stuDetails.hooks");
...
module.exports = function (app) {
  ...
  app.use("/stuDetails", new StuDetails(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("stuDetails");

  // Get the schema of the collections 
  app.get("/stuDetailsSchema", function (request, response) {
